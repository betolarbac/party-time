...
export default function Party() {
  ...
  return (
    <>
      <div
        className="flex mx-auto my-0 flex-col max-w-7xl max-h-60 p-4 shadow-lg rounded-lg"
        key={data._id}
      >
        <img
          src={data.image}
          alt=""
          className="min-h-[350px] rounded-lg object-cover"
        />
        <h2 className="text-center text-4xl font-extrabold uppercase mt-5">
          {data.title}
        </h2>
        <h2 className="text-base font-semibold uppercase mt-5">
          autor: {data.author}
        </h2>
